...
from hyperimpute.plugins.imputers.plugin_sinkhorn import SinkhornPlugin
...
class MiraclePlugin(base.ImputerPlugin):
    ...
    def hyperparameter_space(*args: Any, **kwargs: Any) -> List[params.Params]:
        return [
            ...
            params.Categorical(
                "seed_imputation",
                ["mean", "em", "missforest", "sinkhorn", "gain", "mice"],
            ),
        ]
    ...
    def _get_seed_imputer(self, method: str) -> base.ImputerPlugin:
        if method == "em":
            ...
            return SinkhornPlugin()
        elif method == "gain":
            return GainPlugin()
        elif method == "mice":
            return IterativeChainedEquationsPlugin()
        else:
            return MeanPlugin()
