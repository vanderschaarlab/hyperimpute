...
from hyperimpute.plugins.prediction.regression.plugin_xgboost_regressor import plugin
...
def from_api() -> PredictionPlugin:
    return Predictions(category="regression").get("xgboost_regressor")
...
def test_xgboost_plugin_name(test_plugin: PredictionPlugin) -> None:
    assert test_plugin.name() == "xgboost_regressor"
